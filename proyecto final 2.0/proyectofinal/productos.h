...
public:
	...
	void crear() {
		...
		if (cn.getConectar()) {
			...
			cin >> ex;
			string insert = "INSERT INTO productos(producto,descripcion,imagen,precio_costo,precio_venta,existencia,fecha_ingreso) VALUES ('" + Nproducto + "','" + descripcion + "','" + imagen + "','" + pc+ "','" + pv + "','"+ex+"',current_time());";
	...
	void leer() {
		...
		cn.abrir_conexion();
		if (cn.getConectar()) {
			string consulta = "select idProducto,producto,descripcion,imagen,precio_costo,precio_venta,existencia,fecha_ingreso from productos";
			...
			if (!q_estado) {
				...
				while (fila = mysql_fetch_row(resultado)) {
					cout << "Id" << "        " << "Producto" << "       " << "Descripcion" << "         " << "IMG" << "       " << "Precio Costo" << "        " << "Precio venta " << "        " << "Existencia" << "        " << "fecha ingreso" << endl;
	...
	void actualizar() {
		...
		if (cn.getConectar()) {
			...
			string update = "UPDATE productos SET nombres ='" + producto + "',descripcion ='" + descripcion + "',imagen = '" + imagen + "',precio_costo='" + pc + "',precio_venta ='" + pv + "'  WHERE idCliente = '" + producto + "'";
